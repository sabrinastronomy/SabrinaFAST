...
def wget_folder(folder, files_wanted, website):  # Full output from monitoring file
    ...
    for file_name in files_wanted:
        ...
        subprocess.call(
            "wget " + website + folder + "/fil_files/" + file_name + " -O " + folder + "_" + str(i) + ".fil",
            shell=True)
        i += 1
    os.chdir(savedPath)
...
if __name__ == "__main__":
    ...
    files_wanted_prefixes = ["BJ0009_025", "PM0141_017", "SMC021_008", "2011-02-20-01:52:19.fil",
                             "2011-06-26-21:31:05.fil", "2011-07-03-18:57:42.fil", "2012-01-27-08:08:14.fil"]
