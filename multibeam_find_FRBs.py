...
def candplots(filter_cut, snr_cut=10, max_cands_per_sec=1, nbeams_cut=1):
    ...
    subprocess.call(
        "frb_detector.py -cands_file *_all.cand -snr_cut %f -filter_cut %d -nbeams_cut %d -max_cands_per_sec %f -verbose" % (
        snr_cut, filter_cut, nbeams_cut, max_cands_per_sec)
    subprocess.call(
        "frb_detector.py -cands_file *_all.cand -snr_cut %f -filter_cut %d -nbeams_cut %d -max_cands_per_sec %f > FRBcand" % (
        snr_cut, max_cands_per_sec)
